...
/**
 * ¬ методе main создать 3 потока типа CounterThread, передва один итот де объект Counter и запустить их,
 * дождатьс€ выполнени€ и вывести на консоль текущее значение нашего счетчика counter.getCount()
 */
